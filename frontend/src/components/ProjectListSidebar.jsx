            ...
            <div key={project.id} style={{ marginBottom: "12px" }}>
              ...
              <div
                style={{
                  ...
                  cursor: "pointer",
                  backgroundColor:
                    selectedId === project.id ? "#EDE9FE" : "#F5F3FF",
                  border:
                    selectedId === project.id ? "2px solid #DDD6FE" : "none",
                  transition: "all 0.2s cubic-bezier(0.4, 0, 0.2, 1)",
                }}
                onMouseOver={(e) => {
                  ...
                  {expandedProjects[project.id] ? (
                    <FaChevronDown
                      style={{
                        marginRight: "12px",
                        color:
                          selectedId === project.id ? "#7C3AED" : "#8B5CF6",
                        fontSize: "16px",
                      }}
                    />
                  ) : (
                    ...
                    <div key={image.id} style={{ marginBottom: "8px" }}>
                      ...
                      <div
                        style={{
                          ...
                          cursor: "pointer",
                          backgroundColor:
                            selectedId === image.id ? "#FEF3C7" : "#FEF9C3",
                          border:
                            selectedId === image.id
                              ? "2px solid #FDE68A"
                              : "none",
                        ...
                        >
                          <FaImage
                            style={{
                              marginRight: "12px",
                              color:
                                selectedId === image.id ? "#B45309" : "#D97706",
                              fontSize: "16px",
                            }}
                          />
                          <span
                            ...
                            style={{
                              ...
                              fontWeight: "600",
                              color:
                                selectedId === image.id ? "#B45309" : "#92400E",
                              fontSize: "16px",
                            }}
                          >
                            {image.title}
